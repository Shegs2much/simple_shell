...
/**
 * _help_all - Displays all possible builtin shellby commands
 */
...
/**
 * _help_alias - Displeay information on the shellby builtin command 'alias'
 */
...
/**
 * _help_help - Displays information on the shellby builtin command 'help'
 */
...
/**
 * _help_cd - Displays information on the shellby builtin command 'cd'
 */
...
/**
 * _help_exit - Displays information on the shellby builtin command 'exit'
 */
